...
public class Genio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Geni
     */
    public Genio() {
        initComponents();
        lblFrase.setText("<html> Tente acertar um numero de 1 a 5. Estou pensando...<html>");
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(95, 95, 95)
                        .addComponent(lblFrase, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(40, 40, 40)
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        /*int num = 0, adv = 0;
        Integer.parseInt(spnNum.getValue().toString());
        Random gerador = new Random();
            ...
            if (adv==num){
                ...
                lblFrase.setText("Errou! Estava pensando no..");
            }*/
      double n = 1 + Math.random()*(6-1);
      int valor = (int) n;
      int num = Integer.parseInt(spnNum.getValue().toString());
      String f1 = "ACERTOU";
      String f2 = "ERROU, tava pensando no.."+valor;
